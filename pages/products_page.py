...
class ProductsPage(BasePage):
    ...
    def fill_search_field(self, test_data: dict) -> None:
        ...
        self.fill(self.search_field, test_data["search_item_name"])
    ...
    def add_first_item_to_cart(self) -> None:
        ...
        self.hover(self.first_item_cart)
        self.click(self.add_to_cart_button_first_item)
    ...
    def add_second_item_to_cart(self) -> None:
        ...
        self.hover(self.second_item_cart)
        self.click(self.add_to_cart_button_second_item)
    ...
    def increase_quantity(self, test_data: dict) -> None:
        ...
        self.fill(self.quantity_field, test_data["quantity_field"])
    ...
    def click_register_login_to_proceed_checkout_link(self) -> None:
        ...
        self.click(self.register_login_to_proceed_checkout_link)
    ...
    def input_comment_for_order(self, test_data: dict) -> None:
        ...
        self.fill(self.comment_about_order, test_data["comment_for_prodcut"])
    ...
    def fill_payment_card_fields(self, test_data: dict) -> None:
        ...
        self.fill(self.name_on_card_field, test_data["name_on_card"])
        self.fill(self.card_number_field, test_data["card_number"])
        self.fill(self.cvc_field, test_data["cvc"])
        self.fill(self.expiration_MM_field, test_data["expiration_MM"])
        self.fill(self.expiration_YYYY_field, test_data["expiration_YYYY"])
    ...
    def click_cart_delete_icon(self) -> None:
        ...
        self.click(self.cart_delete_icon)
    ...
    def filter_women_subcategory_item(self) -> None:
        ...
        self.click(self.women_category_plus_icon)
        self.click(self.women_category_dress)

    def filter_men_subcategory_item(self) -> None:
        self.logger.info("Filtering men subcategory item")
        self.click(self.men_category_plus_icon)
        self.click(self.men_category_tshirts)
        

    def filter_kids_subcategory_item(self) -> None:
        self.logger.info("Filtering kids subcategory item")
        self.click(self.kids_category_plus_icon)
        self.click(self.kids_category_dress)
    ...
    def filter_items_by_brand_polo(self) -> None:
        ...
        self.click(self.brand_name_polo)
    ...
    def filter_items_by_brand_babyhug(self) -> None:
        ...
        self.click(self.brand_name_babyhug)
    ...
    def fill_review_form(self, test_data: dict) -> None:
        ...
        self.fill(self.review_name_field, test_data["name"])
        self.fill(self.review_email_field, test_data["email"])
        self.fill(self.review_field, test_data["review_message"])
