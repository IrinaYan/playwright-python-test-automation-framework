...
class HomePage(BasePage):
    ...
    def input_email_in_subscribtion_field(self, test_data: dict) -> None:
        ...
        self.fill(self.subscribtion_email_field, test_data["email"])
