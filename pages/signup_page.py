...
class SignupPage(BasePage):
    ...
    def click_new_user_sign_up_link(self) -> None:
        ...
        self.click(self.new_user_sign_up_link)


    def fill_new_user_signup_form(self, registered_user: dict) -> None:
        self.logger.info("Filling new user signup form")
        self.fill(self.name_field, registered_user["name"])
        self.fill(self.email_address_field, registered_user["email"])
    ...
    def fill_new_user_signup_form_with_ivalid_email_format(self, test_data: dict) -> None:
        ...
        self.fill(self.email_address_field, test_data["invalid_email"])
    ...
    def enter_account_info(self, test_data: dict) -> None:  # test_data is a fixture which is in conftest.py file
        ...
        self.fill(self.password_field_signup_page, PASSWORD) 
    ...
    def enter_address_info(self, test_data: dict) -> None:
        ...
        self.fill(self.first_name_field, test_data["first_name"])
        self.fill(self.last_name_field, test_data["last_name"])
        self.fill(self.company_field, test_data["company"])
        self.fill(self.address_field, test_data["address"])
        self.select_country.select_option(test_data["country"])
        self.fill(self.state_field, test_data["state"])
        self.fill(self.city_field, test_data["city"])
        self.fill(self.zipcode_field, test_data["zip_code"])
        self.fill(self.mobile_number_field, test_data["mobile_number"]) 
    ...
    def click_continue_button_on_deleted_account_page(self) -> None:
        ...
        self.click(self.continue_button_in_deleted_account_page)
